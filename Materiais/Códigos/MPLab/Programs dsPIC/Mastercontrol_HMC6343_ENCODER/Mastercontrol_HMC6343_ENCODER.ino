...
int setpoint = 30;
int setpointzero = 0;
float setpointnovareferencia = 0;
...
///Mudança de variaveis para evitar singularidade
  ...
  //setpointnovareferencia = (compass.heading/10.0) - setpoint; IMU
  ...
  setpointnovareferencia = Angulo - setpoint; //ENCODER
  
  if (setpointnovareferencia >=180.0)
  {
...
delay(1000); // Minimum delay of 200ms (HMC6343 has 5Hz sensor reads/calculations)
}
