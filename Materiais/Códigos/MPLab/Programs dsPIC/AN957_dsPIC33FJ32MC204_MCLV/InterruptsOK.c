...
void __attribute__((interrupt, no_auto_psv)) _IC2Interrupt (void)
{
	...
	if (Flags.Direction==0)
	{
        ...
        //motorcontrol(estado); //Acionamento do motor
}
...
void __attribute__((interrupt, no_auto_psv)) _T3Interrupt (void)
{
    ...
    float velocidaderads = velocidade*0.104719755;
    float setpointrads = setpoint*0.104719755;

    ek = setpointrads - velocidaderads;

    uk = uk1 + (0.02293*ek) - (0.02201*ek1);
