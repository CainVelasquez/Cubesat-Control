...
//#define CLOSEDLOOP
#define FOSC  120000000			// xtal = 10.0Mhz, 120.0Mhz after PLL
#define FCY  FOSC/2				
#define MILLISEC FCY/60000		// 1 mSec delay constant
#define FPWM 39000
